...
#region Methods exposed by Gaia as buttons must be prefixed with GX_
        ...
        {
            EditorUtility.DisplayDialog("Digger", "Digger is a simple yet powerful tool to create natural caves and overhangs in your Unity terrains directly from the Unity editor.", "OK");
        }
        /// <summary>
        /// Setup Terrain
        /// </summary>
