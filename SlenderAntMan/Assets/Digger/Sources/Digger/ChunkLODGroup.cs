    ...
    public class ChunkLODGroup : MonoBehaviour
    {
                                             ...
                                             LayerMask layer)
        {
            ...
            if (digger.CreateLODs) {
                ...
                {
                    ChunkObject.Create(1, chunkPosition, chunkLodGroup, digger.ColliderLodIndex == 0, digger, terrain, materials, layer),
                    ChunkObject.Create(2, chunkPosition, chunkLodGroup, digger.ColliderLodIndex == 1, digger, terrain, materials, layer),
                    ChunkObject.Create(4, chunkPosition, chunkLodGroup, digger.ColliderLodIndex == 2, digger, terrain, materials, layer)
                };
        ...
        public void UpdateStaticEditorFlags()
        {
            for (var i = 0; i < chunks.Length; i++) {
                var chunk = chunks[i];
                chunk.UpdateStaticEditorFlags(IndexToLod(i));
            }
        }
